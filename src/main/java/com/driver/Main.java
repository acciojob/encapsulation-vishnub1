...
Task 6: Now, try setting a value to name in Main function using setter function
        and access it's value using getter function Learnings:

        Encapsulation is used for hidding data, you can create a readOnly member,
        by just implementing getter funtion for that Or you can also create a writeOnly member,
        by just implementing setter function for that
*/
public class Main {
    public static void main(String[] args) {
        RWOnly obj = new RWOnly();
        obj.setName("John"); // Setting value using setter
        System.out.println(obj.getName()); // Accessing value using getter
    }
}